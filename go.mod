module github.com/Fyve-Labs/pocket-dex

go 1.25.0

require (
	github.com/dexidp/dex v0.0.0-20260316160653-6b9ce00e119e
...
require (
	...
	github.com/dexidp/dex/api/v2 v2.4.1-0.20260316160653-6b9ce00e119e // indirect
